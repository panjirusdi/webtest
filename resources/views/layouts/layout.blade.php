...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            .flex{display:flex}.font-semibold{font-weight:600}.h-5{height:1.25rem}.h-8{height:2rem}.h-16{height:4rem}.text-sm{font-size:.875rem}.text-lg{font-size:1.125rem}.mt-4{margin-top:1rem}.mt-8{margin-top:2rem}.p-6{padding:1.5rem}
        </style>
    </head>
    <body>
